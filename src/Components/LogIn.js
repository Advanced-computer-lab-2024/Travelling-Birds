			...
			{showTermsModal && (
				<div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
					<div className="bg-white p-8 rounded shadow-md w-4/5 max-w-4xl">
						...
						>
							<p>
								...
								<ul>
									...
									<li>
										<p><strong>"Company"</strong> (referred to as either "the Company", "We", "Us"
											or "Our" in this Agreement) refers to [___COMPANY_INFORMATION___].</p>
									</li>
									<li>
									...
									<li>
										<p><strong>"Content"</strong> refers to content such as text, images, or other
											...
											available by You, regardless of the form of that content.</p>
									</li>
									<li>
									...
									<li>
										<p><strong>"Feedback"</strong> means feedback, innovations or suggestions sent
											by You regarding the attributes, performance or features of our Service.</p>
									</li>
									<li>
										<p><strong>"Service"</strong> refers to the Website.</p>
									</li>
									<li>
										<p><strong>"Terms and Conditions"</strong> (also referred as "Terms" or "Terms
											of Use") mean these Terms and Conditions that form the entire agreement
											between You and the Company regarding the use of the Service. This Terms and
											Conditions Agreement was generated by <a
								...
								<p>You are responsible for safeguarding the password that You use to access the Service
									...
									Our Service or a Third-Party Social Media Service.</p>
								...
								<p>Our Service allows You to post Content. You are responsible for the Content that You
									post to the Service, including its legality, reliability, and appropriateness.</p>
								...
								<p>You may not transmit any Content that is unlawful, offensive, upsetting, intended to
								...
								<ul>
									...
									<li>Defamatory, discriminatory, or mean-spirited content, including references or
										commentary about religion, race, sexual orientation, gender, national/ethnic
										origin, or other targeted groups.
									</li>
									<li>Spam, machine – or randomly – generated, constituting unauthorized or
										unsolicited advertising, chain letters, any other form of unauthorized
										solicitation, or any form of lottery or gambling.
									</li>
									<li>Containing or installing any viruses, worms, malware, trojan horses, or other
									...
									<li>Infringing on any proprietary rights of any party, including patent, trademark,
								...
								<p>The Company reserves the right, but not the obligation, to, in its sole discretion,
									...
									limit or revoke the use of the Service if You post such objectionable Content.<br/>
									As the Company cannot control all content posted by users and/or third parties on
									the Service, you agree to use the Service at your own risk. You understand that by
									using the Service You may be exposed to content that You may find offensive,
									indecent, incorrect or objectionable, and You agree that under no circumstances will
									the Company be liable in any way for any content, including any errors or omissions
									in any content, or any loss or damage of any kind incurred as a result of your use
									of any content.</p>
								<p><strong>Content Backups</strong></p>
								<p>Although regular backups of Content are performed, the Company does not guarantee
									there will be no loss or corruption of data.</p>
								<p>Corrupt or invalid backup points may be caused by, without limitation, Content that
									is corrupted prior to being backed up or that changes during the time a backup is
									performed.</p>
								<p>The Company will provide support and attempt to troubleshoot any known or discovered
									...
									restore Content to a usable state.</p>
								<p>You agree to maintain a complete and accurate copy of any Content in a location
									independent of the Service.</p>
								...
								<p>We respect the intellectual property rights of others. It is Our policy to respond to
									...
									intellectual property infringement of any person.</p>
								<p>If You are a copyright owner, or authorized on behalf of one, and You believe that
									...
									([___COPYRIGHT_AGENT_CONTACT_EMAIL___]) and include in Your notice a detailed
								...
								<p>You can contact our copyright agent via email
									([___COPYRIGHT_AGENT_CONTACT_EMAIL___]). Upon receipt of a notification, the Company
								...
								<p>The Service and its original content (excluding Content provided by You or other
									users), features and functionality are and will remain the exclusive property of the
									Company and its licensors.</p>
								<p>The Service is protected by copyright, trademark, and other laws of both the Country
									and foreign countries.</p>
								<p>Our trademarks and trade dress may not be used in connection with any product or
									service without the prior written consent of the Company.</p>
								<p><strong>Your Feedback to Us</strong></p>
								<p>You assign all rights, title and interest in any Feedback You provide the Company. If
								...
								<p>Upon termination, Your right to use the Service will cease immediately. If You wish
									to terminate Your Account, You may simply discontinue using the Service.</p>
								...
								<p>Notwithstanding any damages that You might incur, the entire liability of the Company
									...
									the Service or 100 USD if You haven't purchased anything through the Service.</p>
								...
								<p>You represent and warrant that (i) You are not located in a country that is subject
									...
									on any United States government list of prohibited or restricted parties.</p>
						...
						{showAcceptButton && (
							<button
								className="w-full bg-[#330577] text-white py-2 rounded mt-4 hover:bg-opacity-80"
