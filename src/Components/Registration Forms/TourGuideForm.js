...
const TourGuideRegisterForm = ({ onChangeRole }) => {
	...
	const validateForm = () => {
		...
		if (certificates.length === 0) newErrors.certificates = 'The field above is required';
	...
	return (
		<div className="bg-white shadow-lg rounded-lg  p-4 w-full max-w-sm mx-auto">
			...
			<div className="mb-2">
				<label className="block text-gray-700">Certificates</label>
				<input
					type="file"
