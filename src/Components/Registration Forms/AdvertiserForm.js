...
const AdvertiserRegisterForm = ({ onChangeRole }) => {
	...
	const handleRegister = async () => {
		...
		try {
			...
			formData.append('role', 'advertiser');
		...
		<div className="bg-white shadow-lg rounded-lg p-4 w-full max-w-sm mx-auto">
			...
			<div className="mb-2">
				...
				<input
					...
					className="w-full p-2 border border-gray-300 rounded mt-0.5-1"
				/>
