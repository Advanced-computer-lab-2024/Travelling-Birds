...
const ResultsList = ({ activities, itineraries, museums, historicalPlaces }) => {
    return (
        <div className="p-4">
            {/* Activities Section */}
            <h2 className="text-3xl font-bold text-[#330577] mb-6 text-center">Upcoming Activities</h2>
            ...
            {/* Itineraries Section */}
            <h2 className="text-3xl font-bold text-[#330577] mb-6 text-center">Upcoming Itineraries</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <h2 className="text-3xl font-bold text-[#330577] mb-6 text-center">Historical Places</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {historicalPlaces && historicalPlaces.length > 0 ? (
                    ...
                    <p className="text-gray-500">No historical places found.</p>
                )}
            </div>

            {/* Museums Section */}
            <h2 className="text-3xl font-bold text-[#330577] mb-6 text-center">Museums</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
