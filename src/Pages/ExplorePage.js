...
const ExplorePage = () => {
	...
	const handleFilter = async (filterParams) => {
		try {
			...
			setResults({
				activities: filterParams.activeSection === 'activities' ? data.filter(activity => !activity.flaggedInappropriate) : results.activities,
				itineraries: filterParams.activeSection === 'itineraries' ? data.filter(itinerary => itinerary.active && !itinerary.flaggedInappropriate) : results.itineraries,
				historicalPlaces: filterParams.activeSection === 'historicalPlaces' ? data : results.historicalPlaces,
				museums: filterParams.activeSection === 'museums' ? data : results.museums
			});
